      ...
      {isVisible && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 bg-white rounded-2xl shadow-2xl p-8 w-[90%] max-w-md"
          >
            ...
            >
              <a 
                href="tel:+48608480546"
                className="flex items-center space-x-4 p-4 bg-red-50 rounded-xl hover:bg-red-100 transition-colors"
              >
              ...
              <a 
                href="mailto:wakacje@mwnet.us"
                className="flex items-center space-x-4 p-4 bg-yellow-50 rounded-xl hover:bg-yellow-100 transition-colors"
              >
    ...
    <footer className="relative z-10 bg-gradient-to-r from-red-600 to-yellow-500 text-white shadow-lg">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-2xl font-light mb-4">Casa Bella</h3>
            <p className="text-white/80">
              Torre de la Horadada<br />
              03191, Prowincja Alicante<br />
              Hiszpania
            </p>
          </div>
